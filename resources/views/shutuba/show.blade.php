        ...
        <table class="w-full text-sm min-w-[1100px]">
            ...
            <tbody>
                @forelse ($rows as $r)
                    ...
                    @endphp
                    <tr class="border-b dark:border-gray-700 align-top hover:bg-turf-50/30 dark:hover:bg-gray-700/30 transition-colors">
                        {{-- 印ボタン --}}
                        <td class="px-2 py-2">
                        ...
                        <td class="px-2 py-2">
                            ...
                            @else
                                <span class="text-gray-500">-</span>
                            @endif
                            <div class="text-[11px] text-gray-500 dark:text-gray-400">{{ $r->trainer->name ?? '' }}</div>
                        </td>
                ...
                @empty
                    <tr><td colspan="12" class="px-4 py-12 text-center text-gray-500 dark:text-gray-400">
                        該当する出走馬がありません
                    </td></tr>
                @endforelse
            </tbody>
