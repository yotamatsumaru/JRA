<!DOCTYPE html>
<html lang="ja" x-data="{ darkMode: localStorage.getItem('jra_dark') === 'true' }" :class="{ 'dark': darkMode }" class="bg-gray-50 dark:bg-gray-900">
<head>
    <meta charset="UTF-8">
...
<body class="text-gray-800 dark:text-gray-100 dark:bg-gray-900">
@php
    $snap = $share->snapshot ?? [];
    $r = $snap['race'] ?? [];
    $rows = $snap['rows'] ?? [];
...
<div class="max-w-5xl mx-auto p-4 sm:p-6">
    ...
    @endphp
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-black/40 p-4 mt-4">
        <h2 class="text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">印サマリ</h2>
    ...
    {{-- 出走馬テーブル --}}
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-black/40 mt-4 overflow-x-auto">
        <table class="w-full text-sm">
            <thead class="bg-gray-50 dark:bg-gray-700/60 text-xs text-gray-500 dark:text-gray-300">
                <tr>
    ...
    <div class="text-xs text-gray-400 dark:text-gray-500 text-center mt-6">
